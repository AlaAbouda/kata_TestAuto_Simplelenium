...
public class ScenAddClientAccount extends SeleniumTest {
	
	private static  Report rapport=new Report();
	private   String idCase="ScenAddClientAccount";
	  ...
	  public void check_page() throws Exception {
		  String idReport = "0";
			try {
					...
					String[][] tabExcel = ExcelFileRead.read("Data/ScenAddClientAccount.xls", 10, 8);
