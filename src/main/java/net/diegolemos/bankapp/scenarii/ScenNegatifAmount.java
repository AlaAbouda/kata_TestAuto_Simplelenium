...
public class ScenNegatifAmount extends SeleniumTest {
	
	private static  Report rapport=new Report();
	private   String idCase="ScenNegatifAmount";
	  ...
	  public void check_page() throws Exception {
		  String idReport = "0";
			try {
					...
					String[][] tabExcel = ExcelFileRead.read("Data/ScenNegatifAmount.xls", 8, 8);
